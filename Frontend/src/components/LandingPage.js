        ...
        return (
            <div style={backgroundImagePic}>
                <div>
                    ...
                    <Button className="float-right" style={{margin:"25px 15px 25px 850px", backgroundColor: "transparent", fontSize: "20px", fontWeight: "bold", color: "black", border: "1.5px solid black", borderRadius:"5px"}}> Signup </Button>
                    <Button className="float-right" style={{ backgroundColor: "transparent", fontSize: "20px", fontWeight: "bold", color: "black", border: "1.5px solid black", borderRadius:"5px"}}> Login </Button>
                </div>
                    <center>
                        <Image style= {{margin: "200px 50px 25px 50px"}}src={CustomerCarousel}/>
                            <Form inline>

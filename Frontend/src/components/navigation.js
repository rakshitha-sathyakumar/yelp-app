...
render() {
    ...
    <div>
        ...
        <nav class="navbar navbar-light bg-light">
            ...
            <Button href = '/list' style = {{margin:"25px 0px", backgroundColor: "transparent", border: 'none', fontSize: "17px", color: "red", outline: 'none'}} variant='link'> <i class="fas fa-utensils"></i> Restaurant </Button>
